...
const PLAID_CLIENT_ID = plaidKeys.plaidClientId; // YOUR_CLIENT_ID
const PLAID_SECRET = plaidKeys.plaidSecret; // YOUR_SECRET
const PLAID_PUBLIC_KEY = plaidKeys.plaidPublicKey; //YOUR_PUBLIC_KEY
